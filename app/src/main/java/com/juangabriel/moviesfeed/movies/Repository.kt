...
interface Repository {
    open fun getResultFromNetwork(): Observable<Result?>?
    open fun getResultFromCache(): Observable<Result?>?
    open fun getResultData(): Observable<Result?>?
    open fun getCountryFromNetwork(): Observable<String?>?
    open fun getCountryFromCache(): Observable<String?>?
    open fun getCountryData(): Observable<String?>?
}