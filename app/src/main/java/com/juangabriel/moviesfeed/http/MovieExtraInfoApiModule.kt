...
class MovieExtraInfoApiModule {
    ...
    @Provides
    fun provideApiService(): MoviesExtraInfoApisService? {
        return provideRetrofit(BASE_URL, provideClient()).create(
            MoviesExtraInfoApisService::class.java
        )
    }
}